...
`npm run check` enforces the project architecture: every first-party HTML, CSS, and JavaScript source file must remain at or below 300 lines, and every JavaScript component is syntax-checked.
